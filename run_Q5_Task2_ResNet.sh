...
# Run Question 5 Task 2: simple ResNet-like model summary.
...
SCRIPT="$WORKDIR/Q5_Task2_ResNet.py"
LOGFILE="$WORKDIR/q5_task2_resnet_run.log"
PIDFILE="$WORKDIR/q5_task2_resnet.pid"
...
echo "Started Q5 Task 2 ResNet summary -> log: $LOGFILE (pid $(cat "$PIDFILE"))"
